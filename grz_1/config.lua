...
Config.Shop = {
	...
	{3, vector4(-138.88, -633.9, 167.82, 10.52), "ig_mp_agent14", 1, 1, 407, 4, 0.75, 27, "Pôle Emploi"}, -- Pôle Emploi
	{4, vector4(-87.28, 29.9, 70.95, 66.99), "a_m_m_prolhost_01", 1, 1, 459, 4, 0.75, 5, "Magasin électronique"}, -- Magasin électronique
	{5, vector4(-674.28, 5837.94, 16.34, 131.82), "csb_cletus", 1, 1, 141, 4, 0.75, 6, "Magasin de chasse"}, -- Magasin de chasse
	{6, vector4(-1680.96, -291.29, 50.88, 241.08), "ig_priest", 1, 0, 141, 4, 0.75, 6, "Église"}, -- Église
	{7, vector4(-1889.38, 2051.06, 139.99, 159.08), "a_m_m_farmer_01", 1, 1, 176, 4, 0.75, 58, "Vigneron"}, -- Vigneron
	{8, vector4(68.71, -1569.78, 28.59, 28.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{8, vector4(98.45, -225.41, 53.64, 28.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{8, vector4(591.24, 2744.42, 41.04, 188.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{8, vector4(326.53, -1074.25, 28.48, 28.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{8, vector4(213.69, -1835.14, 26.56, 351.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{8, vector4(-3157.74, 1095.24, 19.85, 247.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{8, vector4(-172.74, 6381.28, 30.47, 224.59), "s_m_m_doctor_01", 1, 1, 51, 4, 0.75, 49, "Pharmacie"}, -- Pharmacie
	{9, vector4(456.96, 5571.84, 780.18, 93.59), "s_m_y_armymech_01", 1, 1, 550, 4, 0.75, 38, "Saut aérien"}, -- Parachute
	{10, vector4(2812.21, 5981.91, 349.92, 315.4), "s_m_m_doctor_01", 1, 0, 51, 4, 0.75, 49, "Pharmacie illégal"}, -- Pharmacie illégal
	{11, vector4(2747.57, 3472.92, 54.67, 247.08), "s_m_m_lathandy_01", 1, 1, 237, 4, 0.75, 38, "YouTool"}, -- YouTool
	{12, vector4(2675.67, 3499.29, 52.3, 341.22), "s_m_m_lathandy_01", 1, 0, 237, 4, 0.75, 38, "YouTool back shop"}, -- YouTool back shop
}
...
Config.HuntStore = {
	-- {Label, Name, Price}
	{'License de chasse', 'huntlicense', 20},
	{'Couteau de chasse', 'WEAPON_KNIFE', 5000}, 
	{'Livre de chasse', 'huntmagazine', 5000}, 
}

Config.Vigne = {
	-- {Label, Name, Price}
	{'License de vigneron', 'vigne', 20},
}
